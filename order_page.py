...
class Main:
    def __init__(self, root):
        ...
        self.create_button(login_frame, "VIEW ORDER", self.Login, 45, 50)
        self.create_button(login_frame, "Menu", self.menu, 255, 50)
        self.create_button(login_frame, "Update", self.update, 175, 250)
        self.create_button(login_frame, "ADD ORDER", self.job_registration, 45, 180)
        self.create_button(login_frame, "DELETE ORDER", self.availble_jobs, 255, 180)
